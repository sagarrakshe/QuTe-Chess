...
{
    QInputDialog *input = new QInputDialog(baseWidget);
   ...
   // QLabel *time1 = new QLabel("00:00:00", baseWidget);
    ...
    temp=input->getText(baseWidget,"Player Name", "Enter White Player's Name", QLineEdit::Normal,"",0,0);
    ...
    temp=input->getText(baseWidget,"Player Name", "Enter Black Player's Name", QLineEdit::Normal,"",0,0);
    ...
    moves =new QListWidget(baseWidget);
    moves->setGeometry(1000,105,250,550);
...
void chessBoard(QWidget *baseWidget, Tile *tile[8][8])
{
    ...
    W=60;   //tile no for white king
    B=4;    //tile no for black king
...
int main(int argc, char *argv[])
{
   ...
   QSound::play("/home/work/Music/explosion.wav");
